...
(cl:defmethod cl:initialize-instance :after ((m <Stick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Stick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sensehat_ros-msg:<Stick> is deprecated: use sensehat_ros-msg:Stick instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Stick>))
...
(cl:defmethod direction-val ((m <Stick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensehat_ros-msg:direction-val is deprecated.  Use sensehat_ros-msg:direction instead.")
  (direction m))

(cl:ensure-generic-function 'action-val :lambda-list '(m))
(cl:defmethod action-val ((m <Stick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sensehat_ros-msg:action-val is deprecated.  Use sensehat_ros-msg:action instead.")
  (action m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Stick>)))
  ...
  "7518ab70ca2e75fc897434e945b29029")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Stick)))
  "Returns md5sum for a message object of type 'Stick"
  "7518ab70ca2e75fc897434e945b29029")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Stick>)))
  ...
  (cl:format cl:nil "# Describes the Stick event triggered on the Sense HAT device~%Header header~%# The direction the joystick was moved (\"up\", \"down\", \"left\", \"right\", \"middle\")~%string direction~%# The action that occurred (\"pressed\", \"released\", \"held\")~%string action~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Stick)))
  "Returns full string definition for message of type 'Stick"
  (cl:format cl:nil "# Describes the Stick event triggered on the Sense HAT device~%Header header~%# The direction the joystick was moved (\"up\", \"down\", \"left\", \"right\", \"middle\")~%string direction~%# The action that occurred (\"pressed\", \"released\", \"held\")~%string action~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
