...
"""autogenerated by genpy from sensehat_ros/Stick.msg. Do not edit."""
import codecs
import sys
...
class Stick(genpy.Message):
  _md5sum = "7518ab70ca2e75fc897434e945b29029"
  _type = "sensehat_ros/Stick"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Describes the Stick event triggered on the Sense HAT device
Header header
...
string frame_id
"""
  __slots__ = ['header','direction','action']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Stick, self).__init__(*args, **kwds)
